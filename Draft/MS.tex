...
\centering
\subfigure{
  \includegraphics[width=0.4\linewidth]{figure/npttime.png}
  }
  \subfigure{
  \includegraphics[width=0.4\linewidth]{figure/nptvalue.png}
   }
...
\subfigure{
  \includegraphics[width=0.4\linewidth]{figure/timecompare.png}
  }
  \subfigure{
  \includegraphics[width=0.5\linewidth]{figure/valuecompare.png}
   }
...
\subfigure{
  \includegraphics[width=0.4\linewidth]{figure/function2.png}
  }
  \subfigure{
  \includegraphics[width=0.4\linewidth]{figure/contour.png}
   }
...
\subfigure{
  \includegraphics[width=0.4\linewidth]{figure/function3.png}
  }
  \subfigure{
  \includegraphics[width=0.4\linewidth]{figure/contourtry.png}
   }
...
\subfigure{
  \includegraphics[width=0.4\linewidth]{figure/npttime2.png}
  }
  \subfigure{
  \includegraphics[width=0.4\linewidth]{figure/nptvalue2.png}
   }
...
\subfigure{
  \includegraphics[width=0.4\linewidth]{figure/timecompare2.png}
  }
  \subfigure{
  \includegraphics[width=0.5\linewidth]{figure/valuecompare2.png}
   }
   \caption{(Best viewed in color) Comparison result of three model. Function value is viewed in log scale of difference with oracle obtained by grid search. MF achieves best precision in relatively short time. }
   \label{fig:compare2}
  \end{figure}
